--
-- Function "COUNTRY_VORSCHRIFT_CARD_DETAIL_25APRIL"
--
CREATE OR REPLACE EDITIONABLE FUNCTION "WKSP_THARUN"."COUNTRY_VORSCHRIFT_CARD_DETAIL_25APRIL" (
    p_search_id number, 
    p_milestone number, 
    P_LANDID VARCHAR2,
