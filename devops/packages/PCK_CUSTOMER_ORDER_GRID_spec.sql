--
-- Package "PCK_CUSTOMER_ORDER_GRID"
--
CREATE OR REPLACE EDITIONABLE PACKAGE "WKSP_THARUN"."PCK_CUSTOMER_ORDER_GRID" AS
  ...
  PROCEDURE pDrawCustomers;
  
  -- Draw the product rows
  PROCEDURE pDrawProducts;
  
  -- Draw the order cells in the grid
  PROCEDURE pDrawOrders;
