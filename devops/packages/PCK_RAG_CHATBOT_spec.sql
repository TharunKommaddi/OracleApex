--
-- Package "PCK_RAG_CHATBOT"
--
CREATE OR REPLACE EDITIONABLE PACKAGE "WKSP_THARUN"."PCK_RAG_CHATBOT" AS
  FUNCTION GET_DB_CONTEXT(p_question IN VARCHAR2) RETURN CLOB;
  FUNCTION ASK_RAG(p_question IN VARCHAR2) RETURN CLOB;
END PCK_RAG_CHATBOT;
