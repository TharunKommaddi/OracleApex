--
-- Package "DOCUSIGN_PKG"
--
CREATE OR REPLACE EDITIONABLE PACKAGE "WKSP_THARUN"."DOCUSIGN_PKG" AS
    -- Your DocuSign credentials
    g_account_id CONSTANT VARCHAR2(100) := 'd8ceab46-dd3d-4f82-af3e-1a9ea17735cc';
    g_integration_key CONSTANT VARCHAR2(100) := 'a8a2e2f9-9091-40c1-892c-0f8125a3ddd1';
    g_user_id CONSTANT VARCHAR2(100) := '4decb30b-4564-4ed1-9411-e67f78c8e85d';
    g_client_secret CONSTANT VARCHAR2(100) := 'ce2cf618-f1e0-4340-bbe2-e05aec18b985';
    
    -- DocuSign URLs (Demo environment)
    g_auth_base_uri CONSTANT VARCHAR2(200) := 'https://account-d.docusign.com';
    g_api_base_uri CONSTANT VARCHAR2(200) := 'https://demo.docusign.net';
    
    -- Function declarations
    FUNCTION get_access_token(p_auth_code IN VARCHAR2) RETURN VARCHAR2;
    ...
    PROCEDURE fetch_and_store_envelopes(p_access_token IN VARCHAR2);
    
    FUNCTION create_oauth_url RETURN VARCHAR2;
